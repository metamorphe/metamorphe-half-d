...
* Realworld dimensions to output models (1000 ==> 1000mm)
...
* DONE: _Functionality_ EXPORT AS AN STL
* DONE: _Functionality_ CREATE BOXPLANE OBJECT
* DONE: _Functionality_ REFACTOR CODE TO ASK FOR RELEVANT VERTICES
