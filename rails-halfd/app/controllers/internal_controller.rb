class InternalController < ApplicationController
	...
	def tool
  	...
  	def cure
  		...
  		gcode = `./CuraEngine/build/CuraEngine -c 'CuraEngine/build/#{params[:config]}.cfg' -o public/gcodes/#{params[:name]}.gcode public/#{params[:stl]} -s posx=122500 -s posy=122500
`
